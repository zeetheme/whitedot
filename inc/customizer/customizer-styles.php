...
body{
    color: <?php echo get_theme_mod('whitedot_body_text_color'); ?>;
}

h1, h2, h3, h4, h5, h6{
    color: <?php echo get_theme_mod('whitedot_header_color'); ?>;
}

a{
    color: <?php echo get_theme_mod('whitedot_link_color'); ?>;
}

a:hover{
    color: <?php echo get_theme_mod('whitedot_link_hover_color'); ?>;
}
...
.menu-item-has-children:after{
	color: <?php echo get_theme_mod('header_text_color'); ?>70;
}
...
body{
    font-size: <?php echo get_theme_mod('whitedot_body_text_font_size'); ?>px;
    line-height: <?php echo "calc(" . get_theme_mod('whitedot_body_text_line_height') . "/ 10 )" ?>;
}
